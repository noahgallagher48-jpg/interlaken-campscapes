...
## Log
- 2026-08-03 (later, v2): arrange.html rebuilt on copy semantics per the owner: use-case/theme groups hold COPIES (a frame lives in as many groups as it needs), All frames stays whole as the palette with per-frame placement badges, Out of the vote dims. Export JSON adds an unused list. Foundation for the presented gallery, then the vote groups.
