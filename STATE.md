...
## Log
- 2026-08-06: Field guide v2. New section 06 "After the shutter", the pipeline our guide was missing: split the day among shooters, fixed-hour upload into a dated Drive folder, one cull pass (dupes, bad light, near repeats), six to ten flagged standouts a day, one approver before anything posts, caption voice, end-of-season inventory. Quick reference gained two lines; index guide card mentions the daily routine. Source was a peer camp's media handout the owner photographed on site: its staff names, account/2FA details, program names, and internal approval chain stay out of this repo and off the guide. The Interlaken-specific slots (who approves, what hour, which accounts) are deliberately left blank to set with the media team.
